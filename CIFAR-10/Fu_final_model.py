...
class Dehaze(nn.Module):
    def __init__(self, input_nc,  output_nc, use_dropout=False, padding_type='reflect'):
        ...
        #                          nn.ReLU(True))
        # self.up4 = nn.Sequential(nn.ConvTranspose2d(6, 3, 5, 1, 2, bias=False),
        #                          nn.ReLU(True))
        ...
        self.up2 = nn.Sequential(nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),
                                 ...
                                 nn.BatchNorm2d(64),
                                 nn.ReLU(True))
        self.up3 = nn.Sequential(nn.Conv2d(64, 6, kernel_size=3, stride=1, padding=1),
                                 nn.BatchNorm2d(6),
                                 nn.ReLU(True))
        self.up4 = nn.Conv2d(6, 3, kernel_size=1)
