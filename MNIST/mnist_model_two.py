...
class Dehaze(nn.Module):
    def __init__(self, input_nc,  output_nc, use_dropout=False, padding_type='reflect'):
        ...
        self.down1 = nn.Sequential(nn.Conv2d(input_nc, 64, kernel_size=5, stride=1, padding=2),
                                   nn.BatchNorm2d(64),
                                   nn.ReLU(True))
        self.down2 = nn.Sequential(nn.Conv2d(64, 128, kernel_size=4, stride=2, padding=3), #original：4， 2， 3
                                   nn.BatchNorm2d(128),
                                   nn.ReLU(True))
        self.down3 = nn.Sequential(nn.Conv2d(128, 256, kernel_size=4, stride=2, padding=1),
                                   nn.BatchNorm2d(256),
                                   nn.ReLU(True))
        ...
        #                          nn.ReLU(True))
        self.up1 = nn.Sequential(nn.ConvTranspose2d(256, 128, kernel_size=4, stride=2, padding=1),
                                 nn.BatchNorm2d(128),
                                 nn.ReLU(True))
        self.up2 = nn.Sequential(nn.ConvTranspose2d(128, 64, kernel_size=4, stride=2, padding=3),
                                 nn.BatchNorm2d(64),
        ...
        self.up3 = nn.Sequential(nn.ConvTranspose2d(64, output_nc, 5, 1, 2, bias=False),
                                 nn.BatchNorm2d(2),
                                 nn.ReLU(True))
        self.up4 = nn.Sequential(nn.ConvTranspose2d(2, 1, 5, 1, 2, bias=False))
    ...
    def forward(self, input):
        ...
        x_out_mix = self.mix1(x_down3, x_dcn1)
